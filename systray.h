...
class SysTray : public QQuickItem {
  ...
  Q_PROPERTY(
      QString iconPath READ iconPath WRITE setIconPath NOTIFY iconPathChanged)
  Q_PROPERTY(bool notificationsAllowed READ default WRITE default BINDABLE
...
public:
  ...
  auto notificationsAllowedBindable() -> QBindable<bool> {
