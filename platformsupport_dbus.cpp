...
void PlatformSupport::platformInit()
{
    if (!QDBusConnection::sessionBus().isConnected()) {
        ...
        m_notificationIf = new QDBusInterface(QStringLiteral("org.freedesktop.Notifications"),
                                      ...
                                      const QString &imagePath)
{
    ...
    QDBusReply<quint32> result = m_notificationIf->callWithArgumentList(QDBus::CallMode::AutoDetect,
